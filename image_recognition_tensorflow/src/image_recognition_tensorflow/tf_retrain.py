...
tf.app.flags.DEFINE_string('intermediate_output_graphs_dir','/tmp/intermediate_graph/',
...
tf.app.flags.DEFINE_string('tfhub_module', 'https://tfhub.dev/google/imagenet/inception_v3/feature_vector/1', """
